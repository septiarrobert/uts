			...
			<tr>
				...
				<td>
					<select name="jeniskelamin">
						<option value="Laki-laki" <?php echo $itemmhs['jeniskelamin'] == 'Laki-Laki'?'selected':''?> >Laki-laki</option>
						<option value="Perempuan" <?php echo $itemmhs['jeniskelamin'] == 'Perempuan'?'selected':''?> >Perempuan</option>
					</select>
				</td>
			</tr>
			<tr>
